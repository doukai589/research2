...
\input{tables/inline_table_1.tex}
...
\input{tables/inline_table_2.tex}
...
\input{tables/inline_table_3.tex}
...
\input{tables/inline_table_4.tex}
...
The ST utility-alignment audit tested whether support/candidate-only fold summaries explain which folds benefit from SoftWeight no-reject. The strongest candidate-only feature was \texttt{clean\_\allowbreak artifact\_\allowbreak risk\_\allowbreak raw\_\allowbreak mean}, with Spearman correlation 0.1168 against SoftWeight Macro-F1 gain. This is below the actionable threshold of 0.35.
...
\begin{figure}[H]
\centering
\IfFileExists{figures/figure1_certificate_overview.pdf}{\includegraphics[width=0.95\linewidth]{figures/figure1_certificate_overview.pdf}}{\fbox{\parbox[c][0.24\textheight][c]{0.88\linewidth}{\centering Missing converted figure: figure1_certificate_overview.pdf\\Original SVG is in figures\_svg\_original/.}}}
...
\begin{figure}[H]
\centering
\IfFileExists{figures/figure2_diagnostic_auc.pdf}{\includegraphics[width=0.95\linewidth]{figures/figure2_diagnostic_auc.pdf}}{\fbox{\parbox[c][0.24\textheight][c]{0.88\linewidth}{\centering Missing converted figure: figure2_diagnostic_auc.pdf\\Original SVG is in figures\_svg\_original/.}}}
...
\begin{figure}[H]
\centering
\IfFileExists{figures/figure3_component_specificity_heatmap.pdf}{\includegraphics[width=0.95\linewidth]{figures/figure3_component_specificity_heatmap.pdf}}{\fbox{\parbox[c][0.24\textheight][c]{0.88\linewidth}{\centering Missing converted figure: figure3_component_specificity_heatmap.pdf\\Original SVG is in figures\_svg\_original/.}}}
...
\begin{figure}[H]
\centering
\IfFileExists{figures/figure4_training_policy_non_promotion.pdf}{\includegraphics[width=0.95\linewidth]{figures/figure4_training_policy_non_promotion.pdf}}{\fbox{\parbox[c][0.24\textheight][c]{0.88\linewidth}{\centering Missing converted figure: figure4_training_policy_non_promotion.pdf\\Original SVG is in figures\_svg\_original/.}}}
...
\begin{figure}[H]
\centering
\IfFileExists{figures/figure5_causal_chain.pdf}{\includegraphics[width=0.95\linewidth]{figures/figure5_causal_chain.pdf}}{\fbox{\parbox[c][0.24\textheight][c]{0.88\linewidth}{\centering Missing converted figure: figure5_causal_chain.pdf\\Original SVG is in figures\_svg\_original/.}}}
