...
| SAS-Cert-TFConsistency v0 ST PhysioNetMI | `certificate-routed TF augmentation views` | `workbench/20260624_sascert_tfconsistency_v0_steegformer_physionetmi/outputs/SASCERT_TFCONSISTENCY_V0_REPORT.md` | completed |
| SAS-Cert v3 ST PhysioNetMI | `oracle risky-augmentation routing recoverability` | `workbench/20260624_sascert_v3_certcalibrated_routing_recoverability/outputs/SASCERT_V3_RECOVERABILITY_REPORT.md` | completed |
...
- `workbench/20260624_sascert_tfconsistency_v0_steegformer_physionetmi/outputs`
- `workbench/20260624_sascert_v3_certcalibrated_routing_recoverability/outputs`
