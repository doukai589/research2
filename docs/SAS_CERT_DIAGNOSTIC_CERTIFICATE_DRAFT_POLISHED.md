...
Citation placeholders: EEG foundation models and CBraMod [Wang2025CBraMod], motor-imagery pretraining/reproduction context [Liu2026MIRepNet], limited marginal gains of EEG foundation models [RE199], low-label EEG adaptation and LoRA context [RE132], style-content augmentation [RE309], subject/content latent factorization [RE334], MI physiological priors [RE167], covariance style modeling [RE181], artifact processing [RE333, RE342], prediction stability under stochastic augmentation [RE185].
...
- Bad-type component AUC table: `outputs/runs/sas_cert_diagnostic_certificate_pack_physionetmi/tables/bad_type_component_auc.csv`
