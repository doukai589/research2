...
- Runs: R04, R08, R12.
- Backbones:
  - CBraMod frozen encoder \cite{Wang2025CBraMod}.
  - ST-EEGFormer-small source-tuned frozen encoder \cite{Yang2026STEEGFormer}.
