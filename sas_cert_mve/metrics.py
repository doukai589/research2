...
def classification_metrics(logits: np.ndarray, y_true: np.ndarray, n_classes: int = 4) -> Dict[str, float]:
    ...
    macro_f1 = float(_macro_f1(y_true, y_pred, n_classes))
    kappa = float(_cohen_kappa(y_true, y_pred, n_classes))
    ...
    return {"acc": acc, "macro_f1": macro_f1, "kappa": kappa, "nll": nll, "ece": ece}
